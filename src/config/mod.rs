...
pub const INTERIOR_LIGHT_INTENSITY: f32 = 80_000.0;
pub const OVERHEAD_LIGHT_INTENSITY: f32 = 50_000.0;
pub const INTERIOR_LIGHT_RANGE: f32 = 6.0;
pub const OVERHEAD_LIGHT_RANGE: f32 = 8.0;
