...
pub const INTERIOR_LIGHT_INTENSITY: f32 = 600.0;
pub const OVERHEAD_LIGHT_INTENSITY: f32 = 400.0;
pub const INTERIOR_LIGHT_RANGE: f32 = 4.0;
pub const OVERHEAD_LIGHT_RANGE: f32 = 5.0;
